...
class ProgressPage(CoursePage):
    ...
    def _chapter_index(self, title):
        ...
        try:
            ...
            self.warning(f"Could not find chapter '{title}'")
            return None
    ...
    def _section_index(self, chapter_index, title):
        ...
        section_css = f'.chapters>section:nth-of-type({chapter_index}) .sections div .hd a'
        ...
        try:
            ...
            self.warning(f"Could not find section '{title}'")
            return None
