...
from edxapp_acceptance.pages.studio.utils import HelpMixin, set_input_value_and_save, type_in_codemirror
...
class ContainerPage(PageObject, HelpMixin):
    ...
    def is_browser_on_page(self):
        ...
        def _is_finished_loading():
            ...
            if len(data_request_elements) > 0:
                ...
                num_wrappers = len(
                    self.q(
                        css=u'{} [data-request-token="{}"]'.format(XBlockWrapper.BODY_SELECTOR, request_token)
                    ).results
                )
    ...
    def currently_visible_to_students(self):
        ...
        return warning_text == "Caution: The last published version of this unit is live. " \
