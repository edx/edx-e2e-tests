...
class TestMisc(UserAuthenticationMixin):
    ...
    def test_02_verify_countries_data(self):
        ...
        self.assertEqual('Pakistan', self.profile.selected_country)
        # Get countries list and validate it
        self.assertEqual(COUNTRIES, self.profile.countries_list)
    ...
    def test_03_verify_languages_data(self):
        ...
        self.assertEqual('Urdu', self.profile.selected_language)
        # Get languages list and validate it
        self.assertEqual(LANGUAGES, self.profile.languages_list)
