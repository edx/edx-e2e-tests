...
from e2e.tests.instructor import test_cohorts, test_membership
...
testSuite.addTest(unittest.makeSuite(create_courses.CreateCourse)) # Before suite
...
testSuite.addTest(unittest.makeSuite(delete_all_changes.DeleteAllChanges)) # After suite
